...
class GaussDBDWSIndexMethod(StrEnum):
    ...
    @classmethod
    def default(cls) -> "GaussDBDWSIndexMethod":
        return cls("btree")


@dataclass(frozen=True, eq=True, unsafe_hash=True)
class GaussDBDWSIndexConfig(RelationConfigBase, RelationConfigValidationMixin):
    """
    This config fallows the specs found here:
    https://support.huaweicloud.com/sqlreference-910-dws/dws_06_0165.html
    ...
    method: GaussDBDWSIndexMethod = field(default=GaussDBDWSIndexMethod.default(), hash=True)
    ...
    @classmethod
    def from_dict(cls, config_dict) -> "GaussDBDWSIndexConfig":
        ...
        index: "GaussDBDWSIndexConfig" = super().from_dict(kwargs_dict)  # type: ignore
        return index
...
@dataclass(frozen=True, eq=True, unsafe_hash=True)
class GaussDBDWSIndexConfigChange(RelationConfigChange, RelationConfigValidationMixin):
    """
