...
class TestGaussDBDWSTestRefreshMaterializedView:
    """
    this test addresses a issue in gaussdbdws around materialized views,
    ...
    def test_gaussdbdws_refresh_dependent_naterialized_views(self, project):
        run_dbt(["seed"])
