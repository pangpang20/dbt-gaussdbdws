...
# a name. These tests verify the default gaussdbdws rules for relation names are followed. Adapters
...
class TestGeneratedDDLNameRules:
    ...
    # 63 characters is the character limit for a table name in a gaussdbdws database
