...
class TestGaussDBDWSAdapter(TestCase):
    def setUp(self):
        project_cfg = {
            "name": "X",
            "version": "0.1",
    ...
    def adapter(self):
        if self._adapter is None:
            ...
            inject_adapter(self._adapter, GaussDBDWSPlugin)
        return self._adapter

    @mock.patch("dbt.adapters.gaussdbdws.connections.psycopg2")
    def test_acquire_connection_validations(self, psycopg2):
        ...
        self.assertEqual(connection.type, "gaussdbdws")
    ...
    @mock.patch.object(GaussDBDWSAdapter, "execute_macro")
    @mock.patch.object(GaussDBDWSAdapter, "_get_catalog_relations")
